<?php
$permalink = (!empty(get_field('external_link'))) ? get_field('external_link') : get_permalink();
$target = (!empty(get_field('external_link'))) ? '_blank' : '_self';
if($type == 'slider'){ ?>
	<div>
		<div class="vc_column-inner">
			...
			<div class="wpb_wrapper">
				<div class="iwithtext">
					...
					<div class="iwt-text">
						<h5 class="subtitle">
							<a href="<?php echo $permalink; ?>" target="<?php echo $target; ?>"> <?php echo get_field('subtitle');?> </a>
						</h5>
						<h3 class="title">
							<a href="<?php echo $permalink; ?>" target="<?php echo $target; ?>"> <?php echo get_the_title(); ?> </a>
						</h3>
						<div class="excerpt">
							<a href="<?php echo $permalink ?>" target="<?php echo $target ?>">Read More…</a>
...
<?php }else{
if($i == 1 && (int)$page == 1){?>
	<div class="vc_col-sm-12 wpb_column column_container vc_column_container col child_column no-extra-padding instance-31"
			...
			<div class="wpb_wrapper">
				<div class="iwithtext">
						...
						<div class="post_image">
							<a href="<?php echo $permalink; ?>" target="<?php echo $target; ?>">
								<?php if (has_post_thumbnail()):
									...
									$alt = get_post_meta($id, '_wp_attachment_image_alt', true);
									?>
									<img src="<?php echo $src[0]; ?>" width="<?php echo $src[1]; ?>"
										height="<?php echo $src[2]; ?>" srcset="<?php echo esc_attr($srcset); ?>"
										sizes="<?php echo esc_attr($sizes); ?>" alt="<?php echo esc_attr($alt); ?>">
								<?php endif; ?>
							</a>
						</div>
					</div>
					<div class="iwt-text">
						...
						<h3 class="title">
							<a href="
						<?php echo $permalink; ?>" target="<?php echo $target; ?>"> <?php echo get_the_title(); ?> </a>
						</h3>
						<div class="excerpt">
							<?php echo wp_trim_words(get_the_excerpt(), 15); ?>
						</div>
